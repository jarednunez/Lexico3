...
namespace LYA1_Lexico3
{
   ...
   int[,] TRAND =
        {
        //  WS,L,D,.,E,+,-,La,=,;,&, |,  !, <, >,  %, /, *
            {0,1,2,8,1,19,20,8,8,10,11,12,13,17,16,22,22,22,24}, // 0
            {F,1,1,F,1,F, F, F,F,F, F, F, F, F, F, F, F, F, F}, // 1
            {F,F,2,3,5,F, F, F,F,F, F, F, F, F, F, F, F, F, F}, // 2
            {E,E,4,E,E,E, E, E,F,F, F, F, F, F, F, F, F, F, F}, // 3
            {F,F,4,F,5,F, F, F,F,F, F, F, F, F, F, F, F, F, F}, // 4
            {E,E,7,E,E,6, 6, E,F,F, F, F, F, F, F, F, F, F, F}, // 5
            {E,E,7,E,E,E, E, E,F,F, F, F, F, F, F, F, F, F, F},// 6
            {F,F,7,F,F,F, F, F,F,F, F, F, F, F, F, F, F, F, F}, // 7
            {F,F,F,F,F,F, F, F,9,F, F, F, F, F, F, F, F, F, F},// 8
            ...
            {F,F,F,F,F,F, F, F,F,F, F, F,  F, F, 16,F,F, F, F}, // 17
            {F,F,F,F,F,F, F, F,F,F, F, F, F, F, F, F, F, F, F}, // 18
            {F,F,F,F,F,21,F, F,F,F, F, F,  F, F, F,F, F, F, F}, // 19
            {F,F,F,F,F,F,21, F,F,F, F, F,  F, F, F,F, F, F, F}, // 20
