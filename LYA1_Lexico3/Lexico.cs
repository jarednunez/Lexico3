...
namespace LYA1_Lexico3
{
   ...
   int[,] TRAND =
        {
        //  WS,L,D,.,E,+,-,La,=,;,&, |,  !, <, >,  %, *, ?, ",    /.  {  }, EOF, EOL,
            {0,1,2,8,1,19,20,8,8,10,11,12,13,17,16,22,22,24,25,26,28,32,33,F,0}, // 0
            {F,1,1,F,1,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 1
            {F,F,2,3,5,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 2
            {E,E,4,E,E,E, E, E,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 3
            {F,F,4,F,5,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 4
            {E,E,7,E,E,6, 6, E,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 5
            {E,E,7,E,E,E, E, E,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F},// 6
            {F,F,7,F,F,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 7
            {F,F,F,F,F,F, F, F,9,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F},// 8
            {F,F,F,F,F,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, //9
            {F,F,F,F,F,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 10
            {F,F,F,F,F,F, F, F,F,F, 14,F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 11
            {F,F,F,F,F,F, F, F,F,F, F, 14,F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 12
            {F,F,F,F,F,F, F, F,9,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 13
            {F,F,F,F,F,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 14
            {F,F,F,F,F,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 15
            {F,F,F,F,F,F, F, F,9,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 16
            {F,F,F,F,F,F, F, F,9,F, F, F, F, F, 16,F, F, F,  F,F, F,F, F,F,F}, // 17
            {F,F,F,F,F,F, F, F,F,F, F, F, F, F, F, F, F, F,  F,F, F,F, F,F,F}, // 18
            ...
            {F,F,F,F,F,F, F, F,F,F,F, F, F, F, F, F, F, F,   F,F, F,F,F,F,F}, // 28
            {F,F,F,F,F,F, F,F,F,F, F, F, F, F, F, F, F, F,  F,F, F, F,F,F,F}, // 29
            {F,F,F,F,F,F, F,F,F,F, F, F, F, F, F, F, F, F,  F,F, F, F,F,F,F}, // 30
            {F,F,F,F,F,F, F,F,F,F, F, F, F, F, F, F, F, F,  F,F,F,F, F,F,F}, // 31
